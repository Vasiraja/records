...
export const usersDataSchema = Type.Pick(usersSchema, ['FullName','Email','Password'], {
  $id: 'UsersData'
})
...
export const usersPatchResolver = resolve<UsersPatch, HookContext<UsersService>>({})
 ...
 export const usersQueryProperties = Type.Pick(usersSchema, ['_id', 'FullName','Email','Password'])
