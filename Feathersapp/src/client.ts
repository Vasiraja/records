...
import { employeesClient } from './services/emp/emp.shared'
export type { Employees, EmployeesData, EmployeesQuery, EmployeesPatch } from './services/emp/emp.shared'
...
export const createClient = <Configuration = any,>(
  ...
  client.configure(employeesClient)
  return client
}
