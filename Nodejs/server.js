...
const readPipeStreams = fs.createReadStream("../largefile.mp4");
const writePipeStreams  = fs.createWriteStream("files/newupdated.mp4");

const checkUn =readPipeStreams.pipe(writePipeStreams);
if(checkUn){
    console.log("Large file copied through stream pipe")
} 
