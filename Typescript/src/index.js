...
var value = "this is the value here";
console.log(value);
console.log("The console start here");
console.group("the console another");
function submitUser() {
    var inputElement = document.querySelector("#inputgiven");
    var userDiv = document.querySelector(".userlists");
...
var explictStringVal = 'Hello, Hi i am another tring';
var explictBool = false;
var explictNum = 90;
...
var inferenceString = "here string from inference";
var inferenceNum = 3242;
var inferenceBool = false;
...
var tupleArr = [2132, 'stringtuple', false];
...
var eachStudentMarks = [55, 35, 55];
var ganesh = eachStudentMarks[0], vidhun = eachStudentMarks[1], malathi = eachStudentMarks[2];
...
function restFunc(a, b) {
    ...
    return a * b * rest.reduce(function (prev, items) { return prev + items; }, 0);
}
...
function namedFunc(_a) {
    var firstinput = _a.name, secondinput = _a.age;
...
var Employee = /** @class */ (function (_super) {
    ...
    function Employee(name, age, designation) {
        return _super.call(this, name, age, designation) || this;
    }
...
var emp = new Employee("Vasi", 25, "Developer");
...
var Mob = /** @class */ (function () {
    ...
    Mob.prototype.getSound = function () {
        console.log("Mob notify sound");
    };
    return Mob;
}());
var setSound = new Mob();
console.log(setSound.getSound());
console.log("-----v. extends");
var phoneScreen = /** @class */ (function () {
    function phoneScreen(width, height) {
        this.width = width;
        this.height = height;
    }
    return phoneScreen;
}());
var realmeScreen = /** @class */ (function (_super) {
    __extends(realmeScreen, _super);
    function realmeScreen(width, height, breadth) {
        var _this = _super.call(this, width, height) || this;
        _this.breadth = breadth;
        return _this;
    }
    realmeScreen.prototype.getOverallValue = function () {
        var finalValue = this.width + this.height + this.breadth;
        return finalValue;
    };
    return realmeScreen;
}(phoneScreen));
var newSet = new realmeScreen(22, 33, 211);
